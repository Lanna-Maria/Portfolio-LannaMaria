      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            <p className="mb-4 text-gray-300">
              Atuo no desenvolvimento de sistemas completos, do front-end ao
              back-end, com foco em boas práticas de engenharia de software.
              Também possuo experiência acadêmica com Machine Learning,
              aplicando técnicas de aprendizado de máquina em projetos.
            </p>
            <p className="mb-4 text-gray-300">
              ...
              teórica e minha capacidade de resolução de problemas complexos.
            </p>
            <p className="text-gray-300">
              Busco oportunidades como desenvolvedora Full Stack com foco em
              Engenharia de Software ou na área de Machine Learning, aplicando e
              aprimorando meus conhecimentos em desenvolvimento de sistemas,
              análise de dados e boas práticas de engenharia de software.
            </p>{' '}
          </motion.div>
