...
export function Experiencia() {
  ...
  const experiences = [
    ...
    },
    {
      ...
      period: '2021 - 2025',
      achievements: [
        'Desenvolvimento de aplicações web, conceitos de programação e versionamento com Git',
        'Aplicação de conceitos de Aprendizado de Máquina em projetos acadêmicos, incluindo análise de dados e identificação de padrões',
